...
function slider() {
  ...
  document.querySelector(".main-top article section h2").innerHTML =
    content_text[count_slider].h2;
  document.querySelector(".main-top article section p").innerHTML =
    content_text[count_slider].p;
}
